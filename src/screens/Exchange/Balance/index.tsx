    ...
    <div className={styles.balance}>
      ...
      <div className={styles.list}>
        {items.map((x, index) =>
          x.balance ? (
            x.balance[0].status ? (
              <div className={cn(styles.statistics, styles.positive)} key={index}>
              ...
              <div className={cn(styles.statistics, styles.negative)} key={index}>
                <div className={styles.currency}>{x.balance[0].currency}</div>
            ...
            >
              ...
              <div className={styles.line} style={{ width: `${x.percent}%` }}></div>
            </div>
          )
        )}
      </div>
