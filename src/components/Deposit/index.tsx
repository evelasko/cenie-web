    ...
    <div className={styles.deposit}>
      {visibleHead && (
        <div className={styles.head}>
          ...
          <div className={styles.info}>Select a protocol to see the corresponding address.</div>
          ...
          {items[activeIndex].content.map((x, index) => (
            <div className={styles.item} key={index}>
              ...
              <div className={styles.content}>
                Only send USDT to this address. Sending any other asset to this address may result
                in the loss of your deposit!
              </div>
              <div className={styles.code}>
                <div className={styles.number}>0xf8aaa2b1842e796191e736434479</div>
